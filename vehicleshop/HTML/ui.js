function CloseShop() {
    $("#wrapper").html('');
	$("#shopmenu").hide();
    $.post('http://vehicleshop/CloseMenu');
}
...
$(document).ready(function(){
                    ...
                    html += `<div class="col-4 mb-4">
                                <div class="card h-100"style="border:0;border-radius:15px;">
                                    ...
                                    <div class="card-body" style="background-color:grey; border:0;">
                                        ...
                                        <p class="text">Category: <b>`+car.categoryLabel+`</b></p>
    ...
    $("#body").on('click', ':button', function () {
        ...
        if($(this).data('value') == "buy")
            $.post('http://vehicleshop/BuyVehicle', JSON.stringify({model: $(this).data('model')}));
        else if($(this).data('value') == "test-drive")
            $.post('http://vehicleshop/TestDrive', JSON.stringify({model: $(this).data('model')}));
    });
    ...
    window.addEventListener('message', function(event) {
        ...
        $('#brand').html(`<option selected value="-1">Category</option>`)
